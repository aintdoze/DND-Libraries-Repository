            ...
            <tbody>
                ...
                if (!empty($uploadedDocuments)) {
                    foreach ($uploadedDocuments as $document) {
                        ...
                        echo '<td>
                                  <a href="view_details.php?fileID=' . $document['file_id'] . '" class="btn btn-primary btn-sm">View</a>
                                  <a href="delete_document.php?fileID=' . $document['file_id'] . '" class="btn btn-danger btn-sm ml-1" onclick="return confirm(\'Are you sure you want to delete this document?\')">Delete</a>
                              </td>';
                        echo "</tr>";
                    }
                } else {
